...
- Generated: 2026-03-24 18:31 UTC
- Individual insight files: 12

## Cohort Context
- Cohort size: 400
- Variables: 46
- Overall event rate: 48.75%
- Median EFS (months): 30.1
...
![clinical_age_distribution.png](../images/clinical_age_distribution.png)
...
![clinical_stage_distribution.png](../images/clinical_stage_distribution.png)
...
![clinical_risk_distribution.png](../images/clinical_risk_distribution.png)
...
![clinical_efs_by_risk.png](../images/clinical_efs_by_risk.png)
...
![biomarker_mycn_vs_alk.png](../images/biomarker_mycn_vs_alk.png)
...
## Medical Insight
- The strongest absolute biomarker-to-biomarker correlation appears moderate at about 0.29, suggesting partial co-expression rather than complete redundancy.
...
![survival_km_by_risk.png](../images/survival_km_by_risk.png)
...
![survival_km_by_mycn.png](../images/survival_km_by_mycn.png)
...
![survival_event_rate_heatmap.png](../images/survival_event_rate_heatmap.png)
...
### Survival Km Median Split Chgb

# Insights: Survival Km Median Split Chgb

![survival_km_median_split_chgb.png](../images/survival_km_median_split_chgb.png)
...
### Survival Km Median Split Tert

# Insights: Survival Km Median Split Tert

![survival_km_median_split_tert.png](../images/survival_km_median_split_tert.png)
